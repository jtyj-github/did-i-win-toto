...
export const inputTheme = tv({
    ...
    variants: {
        variant: {
            ...
            glass: {
                content: [
                    ...
                    '[&_input::placeholder]:text-text-em-mid',
                    '[&_textarea::placeholder]:text-text-em-mid'
                ]
            }
        },
        size: {
            md: {
                content: ['py-2', 'px-3', 'max-h-9', 'rounded-xl', 'gap-2', 'text-base']
            },
            sm: {
                content: ['px-2.5', 'py-1.5', 'max-h-[30px]', 'rounded-md', 'gap-1.5', 'text-sm']
            }
        },
        hasError: {
            true: {
        ...
        unstyled: {
            true: {
                content: ['border-none', 'bg-transparent', 'text-text-em-high', 'w-fit', 'p-0'],
